...
<body>
	...
	<section>
		<h2>매출 등록</h2>
		<form name="form" action="action.jsp" onsubmit="return help()">
			<table>
				<%
				while (rs.next()) {
				%>
				...
				<tr>
					<td colspan="2">
						<button type="submit">등록</button> <input type="button"
						onclick="location.href='list2.jsp'" value="조회">
					</td>
				</tr>
			</table>
		</form>
