...
<body>
	...
	<section>
		...
		<%
			if(rs.next()){
		%>
		<form name="form" action="action.jsp?custno=<%=custno%>">
			<input type="hidden" name="action" value="update">
			<table>
				<tr>
					<td>회원번호</td>
					<td><input type="text" name="custno" value="<%=rs.getString("custno")%>" readonlys></td>
				</tr>
				<tr>
					<td>회원성명</td>
			...
			<input type="submit" value="수정" onsubmit="return validation()"/>
			<button type="button" onclick="location.href='getMember.jsp'">조회</button>
		</form>
		<%
			}
		%>
